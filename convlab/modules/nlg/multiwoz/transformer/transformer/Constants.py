...
with open(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'data/template.txt'), 'r') as f:
    act_ontology = f.readlines()
    act_ontology = list(map(lambda x:x.strip(), act_ontology))
